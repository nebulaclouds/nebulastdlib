...
func TestWithNamespace(t *testing.T) {
	...
	ctx = WithNamespace(ctx, "nebula")
	assert.Equal(t, "nebula", ctx.Value(NamespaceKey))

	ctx = WithNamespace(ctx, "nebula2")
	assert.Equal(t, "nebula2", ctx.Value(NamespaceKey))
}
...
func TestWithTaskType(t *testing.T) {
	...
	ctx = WithTaskType(ctx, "nebula")
	assert.Equal(t, "nebula", ctx.Value(TaskTypeKey))
}

func TestWithWorkflowID(t *testing.T) {
	ctx := context.Background()
	assert.Nil(t, ctx.Value(WorkflowIDKey))
	ctx = WithWorkflowID(ctx, "nebula")
	assert.Equal(t, "nebula", ctx.Value(WorkflowIDKey))
}

func TestWithLaunchPlanID(t *testing.T) {
	ctx := context.Background()
	assert.Nil(t, ctx.Value(LaunchPlanIDKey))
	ctx = WithLaunchPlanID(ctx, "nebulalp")
	assert.Equal(t, "nebulalp", ctx.Value(LaunchPlanIDKey))
}
...
func TestValues(t *testing.T) {
	...
	assert.Equal(t, "nebula", m[WorkflowIDKey.String()])
