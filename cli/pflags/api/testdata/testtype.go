...
func (cfg TestType) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.IntSlice(fmt.Sprintf("%v%v", prefix, "ints"), DefaultTestType.IntArray, "")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "strs"), DefaultTestType.StringArray, "")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "complexArr"), DefaultTestType.ComplexJSONArray, "")
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "storage.stow.kind"), DefaultTestType.StorageConfig.Stow.Kind, "Kind of Stow backend to use. Refer to github/nebulaclouds/stow")
	cmdFlags.StringToString(fmt.Sprintf("%v%v", prefix, "storage.stow.config"), DefaultTestType.StorageConfig.Stow.Config, "Configuration for stow backend. Refer to github/nebulaclouds/stow")
